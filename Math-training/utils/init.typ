...
#import "math.typ": case-p, eqn, mathenv, proof, claim_p, corollary, definition, example, lemma, lemma_p, problem, property, proposition, remark, solution, subproof, theorem
